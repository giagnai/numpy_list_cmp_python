...
if __name__ == '__main__':
    ...
    personas_en_rango = len(personal_1_10)

    print("La cantidad de personal de ID entre 1 y 10 que paso por el molinete es {} --> ({})".format(personas_en_rango, personal_1_10))
